...
//  private ToggleButton torchButton;
  ...
  private void save(String filename, String data)
  {
      try
      {
          ...
          Log.e(TAG, "Saved data file ItemList.txt, successful.");
      }
      catch (Exception ex)
      {
  ...
  boolean handleOcrDecode(OcrResult ocrResult) {
    ...
    ocrResultTextView.setText(ocrResult.getText());//TODO: this is where the magic happens
    
    Log.e(TAG, "Captured data using OCR");
    //save OCR data to file
    save("ItemList.txt",ocrResult.getText());
    Log.e(TAG, "Saved data to file: ItemList.txt");  
