...
public class EventTest {
	...
	public void setUp() throws Exception {
		...
		this.testTxn.addPayer(item1, ptpt1); //ptpt1 pays for first item
		
		item2 = new Item("Item2", 18.00);
		this.testTxn.addItem(item2);
		this.testTxn.addPayers(item2, ptpts); //all split item2
		...
		this.testTxn.addPayersCustom(item3, customCosts);
